...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var arregloModificado = palabras.join(" ");
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var nuevaSuma = arrayOfNums.reduce(function(acc, el) {
      return acc + el;
   } )
   return nuevaSuma;
}

function promedioResultadosTest(resultadosTes) {
   // El parámetro "resultadosTest" es un arreglo de números.
   // Itera (en un bucle) los elementos del arreglo y devuelve el promedio de las notas.
   // Tu código:
  return (resultadosTes.reduce(function(acc, el){
   return acc + el})) / resultadosTes.length;
}
