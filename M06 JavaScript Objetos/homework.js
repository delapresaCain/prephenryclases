...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   objetoMuchosUsuarios.forEach(function (elemento) {
      elemento.esPremium = true;
   })
   return objetoMuchosUsuarios;

   // objetoMuchosUsuarios.map((usuarios) => {
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   var results = objetoUsuario.posts.reduce((acumulador, elemento) => {
     return acumulador + elemento.likes;
   },0);
